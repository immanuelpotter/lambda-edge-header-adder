...
This is a sample template for lambda-edge-header-adder - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name lambda-edge-header-adder \
...
```bash
aws cloudformation delete-stack --stack-name lambda-edge-header-adder
```
